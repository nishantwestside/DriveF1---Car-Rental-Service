...
?>
  ...
  <style>
      body{
        background-image: linear-gradient(43deg, rgb(0, 0, 0) 0%, rgb(200, 204, 206) 30%, rgb(86, 95, 100) 55%, rgb(0, 161, 155) 100%);
...
.invalid:before {
  ...
  content: "✖";
    ...
    <h1 id="fam">Join Our Community Worldwide</h1>
 <div class="main">
        ...
        <form id="register" action="register.php" method="POST">    
            ...
            <input type="submit" class="btnn"  value="Register" name="regs" style="background-color: rgb(0, 161, 155);color: black">
